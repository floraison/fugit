...
describe Fugit::Cron do
  ...
  NEXT_TIMES = [
    ...
    [ '0 12 10 * *,2',     '2024-01-10 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10 * 2,*',     '2024-01-10 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10 * 2,*|',    '2024-01-01 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10| * 2,*',    '2024-01-01 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10| * 2,*|',   '2024-01-01 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10,* * SUN',   '2024-01-07 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 *,10 * SUN',   '2024-01-07 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10,* * SUN|',  '2024-01-01 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10,*| * SUN',  '2024-01-01 12:00', '2024-01-01', 'UTC' ],
    [ '0 12 10,*| * SUN|', '2024-01-01 12:00', '2024-01-01', 'UTC' ]
  ]
...
#p Fugit::Duration.parse(rf).deflate.to_plain_s
  ...
  describe '.parse' do
    ...
    it 'returns nil if it cannot parse' do
      ...
      expect(Fugit::Cron.parse('0 12 10&| * 2&|')).to eq(nil)
      expect(Fugit::Cron.parse('0 12 10 * 2&|')).to eq(nil)
      expect(Fugit::Cron.parse('0 12 10|& * 2|&')).to eq(nil)
      expect(Fugit::Cron.parse('0 12 10|& * 2')).to eq(nil)
    end
